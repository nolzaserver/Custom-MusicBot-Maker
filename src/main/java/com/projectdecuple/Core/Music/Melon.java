...
public class Melon {
    ...
    // KOREAN MUSIC CHART & MUSIC PLAYER PLATFORM SERVICE.
    // @author PlayerDecuple

    // Copyright (c) 2020 Team Decuple. All rights reserved.
    // If you are trying to use this source code commercially, you cannot use or refer to this source code.
    // Else you may use this source code.

    public Melon() {}

    public String getCharts(int range) throws IOException {
        Document d = Jsoup.connect("https://www.melon.com/chart/week/index.htm")
